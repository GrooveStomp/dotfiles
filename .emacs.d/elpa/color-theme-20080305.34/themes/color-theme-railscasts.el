...
(defun color-theme-railscasts ()
  ...
  (color-theme-install
   '(color-theme-railscasts
     ...
     (font-lock-builtin-face ((t (:foreground "#C095FF"))));"#D0D0FF"))))
     (font-lock-comment-face ((t (:foreground "#8F8F8F"))));"#BC9458" :italic t))))
     (font-lock-constant-face ((t (:foreground "#6D9CBE"))))
     (font-lock-doc-string-face ((t (:foreground "#A5C261"))))
     (font-lock-function-name-face ((t (:foreground "#A6218C" :bold t))));"#FFC66D"))))
     (font-lock-keyword-face ((t (:foreground "#3275FF"))));"#CC7833"))))
     (font-lock-preprocessor-face ((t (:foreground "#CC7833"))))
     (font-lock-reference-face ((t (:foreground "LightSteelBlue"))))
     ;; Really fantastic, bright green: 71C75D
     (font-lock-string-face ((t (:foreground "#749C6B"))));"#A5C261"))))
     (font-lock-type-face ((t (:foreground "#71C75D"))));"white"))))
     ...
     (italic ((t (:italic t))))
     (modeline ((t (:background "#232323" :foreground "white"))));"#A5BAF1" :foreground "black"))))
     (modeline-buffer-id ((t (:background "#3571EE" :foreground 
                                          "black"))))
